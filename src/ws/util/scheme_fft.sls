...
(library (ws util scheme_fft)   
  ...
  ;(define neg2i -2.0i) ;; ikarus parser not ready
  (define-syntax neg2i (identifier-syntax (make-rectangular 0 -2.0)))

  ;; [2008.04.29] Ack, throwing in an arithmetic shift instead of logical.  I *think* it doesn't make a difference here.
