...
(library (ws passes wavescope_bkend nominalize-types)
  (export nominalize-types 
...
#;
  ...
  (define-testing test-nominalize-types
    (default-unit-tester "nominalize types pass" 
      `(
               ...
               (iterate
                ...
                (lambda (w_3 VIRTQUEUE_4)
                 ...
                 (begin
                  ...
                  VIRTQUEUE_4))
                s1_1)])
         (let ([s3_5 (Stream #(Int64 Int Float))
                (iterate
                 ()
                 (lambda (pattmp_6 VIRTQUEUE_9)
                  (#(Int Int64) (VQueue #(Int64 Int Float)))
