...
(library (ws passes wavescope_bkend emit-c)
  (export ;WSBox wscode->text
	   wsquery->text
	   extract-lib-name
...
(define (StructDef entry)
     ;(printf "StructDef entry is: \n") (pretty-print entry) (printf "\n")
     (match entry
...
(define-testing  test-wavescript_emit-c
  (default-unit-tester "wavescript_emit-c.ss: generating WaveScript C code." 
    `(
      [3 3]
