...
Note that these functions may be called as {\tt Matrix:Float:get} or by
first importing the namespace ({\tt using Matrix:Float}) followed by
simply {\tt get}.  Also included are {\tt Matrix:Complex} and {\tt
  Matrix:Double}, which provide interfaces identical to {\tt Matrix:Float}.
