...
\title{WaveScript Rev 3042 User Manual}
...
Use a hash symbol to build a constant array rather than a list, for example \tt{\#[1,2,3]}.
Use
{\em Array:make} to allocate new arrays, {\tt arr[i]} to access arrays, and
