/* 
   This file contains a first draft of some CEP/DB-like WS operators
   to support the kinds of queries we see in stonebreaker_example_queries.ws

   It contains a bunch of "all caps" experimental operators defined
   directly in WS.  These are mostly unused.  The wsq_* operators are
   the ones actually exposed through the WSQ library.  
*/
/****************************************************************************************************/
