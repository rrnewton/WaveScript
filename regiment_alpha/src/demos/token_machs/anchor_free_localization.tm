...
(token locdiff3 () (stored [diff #f])
       (let ([score (round-to 1 (-. 0.0 (locdiff '(0 20) (list (ext-ref coords x) (ext-ref coords y)))))])
	 (set! diff score)
	 (if (eqv? score +nan.0) -1000 score)))
...
(token locdiff4 () (stored [diff #f])
       (let ([score (round-to 1 (-. 0.0 (locdiff '(-20 0) (list (ext-ref coords x) (ext-ref coords y)))))])
	 (set! diff score)
	 (if (eqv? score +nan.0) -1000 score)))
