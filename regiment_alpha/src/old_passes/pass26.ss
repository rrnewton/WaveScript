;===============================================================================
;;; Pass 26: remove-nonunary-let
;;; September 2001

;;; This pass nests let expressions so that each binds a single variable.
    ...
    (define Effect
      (lambda (expr)
        (match expr
          ...
          [,expr (error 'remove-nonunary-let
