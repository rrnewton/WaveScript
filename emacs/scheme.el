...
(defconst scheme-font-lock-keywords-2
  (append scheme-font-lock-keywords-1
   (eval-when-compile
	...
	"(" (regexp-opt
	     '(;; RRN
	       "match" "match+" "trace-match" "trace-match+" "match-lambda" "let-match" 
...
(put 'match+ 'scheme-indent-function 1)
(put 'trace-match 'scheme-indent-function 1)
(put 'trace-match+ 'scheme-indent-function 1)
(put 'match-lambda 'scheme-indent-function 1)
(put 'case-lambda 'scheme-indent-function 0)
(put 'let-match 'scheme-indent-function 1)
(put 'let-stored 'scheme-indent-function 1)
(put 'eval-when 'scheme-indent-function 1)
(put 'parameterize 'scheme-indent-function 1)
(put 'tokens 'scheme-indent-function 0)
(put 'token 'scheme-indent-function 2)
(put 'stored 'scheme-indent-function 0)
(put 'program 'scheme-indent-function 1)
(put 'nodepgm 'scheme-indent-function 1)
...
(put 'map 'scheme-indent-function 1)
(put 'filter 'scheme-indent-function 1)
(put 'foldl 'scheme-indent-function 1)
