...
/****
  custom_init may be redefined to perform boot-time initialization,
  such as registering foreign symbols.  we 'ifdef' it here to allow
  custom_init to be defined in another file.
****/
#ifndef CUSTOM_INIT
